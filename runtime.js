...
defineCommand('perms', async (msg) => { const embed = new EmbedBuilder().setTitle('Permissions du serveur').setColor(0xFF0000).setDescription(['Perm 1','Aucune','Perm 2','Aucune','Perm 3','Aucune','Perm 4','Aucune','Perm 5','Aucune','Perm 6','Aucune','Perm 9','Aucune'].join('\n')).setFooter({ text: 'ζ͜͡Nexus Support' }); await msg.channel.send({ embeds: [embed] }); });
